      ...
      for (unsigned i_2 = 0; i_2 != nof_pol_shifts; ++i_2) {
        ...
        for (unsigned i_layer = 0; i_layer != nof_layers; ++i_layer) {
          std::vector<cf_t> expected_port_weights = get_layer_port_weights(
              {N1, N2, O1, O2, layer_beam[i_layer], i_1_2}, {scaling, scaling * std::polar(1.0f, layer_pol[i_layer])});
...
TEST(precoding_codebooks_test, Type1SinglePanelMode1_OneLayerEightPorts1D)
{
  ...
  for (unsigned i_1_1 = 0; i_1_1 != nof_beams; ++i_1_1) {
    for (unsigned i_2 = 0; i_2 != nof_pol_shifts; ++i_2) {
      ...
      // Layer 0: beam l = i_1_1, phi = pi/2 * i_2.
      std::vector<cf_t> expected_port_weights = get_layer_port_weights(
          {N1, N2, O1, O2, i_1_1, i_1_2},
          {scaling, scaling * std::polar(1.0f, static_cast<float>(M_PI_2) * static_cast<float>(i_2))});
...
TEST(precoding_codebooks_test, Type1SinglePanelMode1_TwoLayerEightPorts1D)
{
...
TEST(precoding_codebooks_test, Type1SinglePanelMode1_ThreeLayerEightPorts1D)
{
...
TEST(precoding_codebooks_test, Type1SinglePanelMode1_FourLayerEightPorts1D)
{
...
TEST(precoding_codebooks_test, Type1SinglePanelMode1_FiveLayerEightPorts1D)
{
...
TEST(precoding_codebooks_test, Type1SinglePanelMode1_SixLayerEightPorts1D)
{
...
TEST(precoding_codebooks_test, Type1SinglePanelMode1_SevenLayerEightPorts1D)
{
...
TEST(precoding_codebooks_test, Type1SinglePanelMode1_EightLayerEightPorts1D)
{
...
TEST(precoding_codebooks_test, Type1SinglePanelMode1_OneLayerEightPorts2D)
{
...
TEST(precoding_codebooks_test, Type1SinglePanelMode1_TwoLayerEightPorts2D)
{
    ...
    for (unsigned i_1_2 = 0; i_1_2 != nof_beams; ++i_1_2) {
      for (unsigned i_1_3 = 0; i_1_3 != nof_offsets; ++i_1_3) {
        for (unsigned i_2 = 0; i_2 != nof_pol_shifts; ++i_2) {
          ...
          for (unsigned i_layer = 0; i_layer != nof_layers; ++i_layer) {
            std::vector<cf_t> expected_port_weights =
                get_layer_port_weights({N1, N2, O, O, layer_beam_h[i_layer], layer_beam_v[i_layer]},
                                       {scaling, scaling * std::polar(1.0f, layer_pol[i_layer])});
...
TEST(precoding_codebooks_test, Type1SinglePanelMode1_ThreeLayerEightPorts2D)
{
...
TEST(precoding_codebooks_test, Type1SinglePanelMode1_FourLayerEightPorts2D)
{
...
TEST(precoding_codebooks_test, Type1SinglePanelMode1_FiveLayerEightPorts2D)
{
...
TEST(precoding_codebooks_test, Type1SinglePanelMode1_SixLayerEightPorts2D)
{
...
TEST(precoding_codebooks_test, Type1SinglePanelMode1_SevenLayerEightPorts2D)
{
...
TEST(precoding_codebooks_test, Type1SinglePanelMode1_EightLayerEightPorts2D)
{
