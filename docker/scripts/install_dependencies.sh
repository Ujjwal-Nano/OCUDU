...
install_dependencies_fedora() {
    ...
    local -a run_pkgs=(
        libatomic fftw lksctp-tools yaml-cpp mbedtls gtest boost-atomic boost-chrono boost-container
        boost-date-time boost-filesystem boost-program-options boost-serialization boost-thread boost-test
    )
    local -a extra_pkgs=(
