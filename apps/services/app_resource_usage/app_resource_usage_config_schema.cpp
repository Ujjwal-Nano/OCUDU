...
#include "app_resource_usage_config_schema.h"
...
void ocudu::app_services::declare_app_resource_usage_config_schema(config::config_builder&    b,
                                                                                app_resource_usage_config& config)
{
  ...
  app_helpers::declare_metrics_appconfig_schema(b, config.metrics_consumers_cfg);
}
