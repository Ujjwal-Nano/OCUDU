...
void ocudu::app_services::configure_cli11_with_executor_metrics_appconfig_schema(config::config_builder&  b,
                                                                                 executor_metrics_config& config)
{
  ...
  app_helpers::configure_cli11_with_metrics_appconfig_schema(b, config.common_metrics_cfg);
}
                                                                                 ...
                                                                                 executor_metrics_config& config)
{
  ...
  configure_cli11_with_executor_metrics_appconfig_schema(b, config);
}
