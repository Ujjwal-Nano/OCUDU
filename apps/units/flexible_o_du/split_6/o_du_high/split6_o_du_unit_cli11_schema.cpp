...
void ocudu::configure_cli11_with_split6_o_du_unit_config_schema(config::config_builder&  b,
                                                                split6_o_du_unit_config& config)
{
  configure_cli11_with_o_du_high_config_schema(b, config.odu_high_cfg);
}
...
void ocudu::configure_cli11_with_split6_o_du_unit_config_schema(CLI::App& app, split6_o_du_unit_config& config)
{
  ...
  configure_cli11_with_split6_o_du_unit_config_schema(b, config);
}
