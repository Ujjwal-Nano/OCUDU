...
#include "apps/units/flexible_o_du/o_du_low/du_low_config_schema.h"
#include "apps/units/flexible_o_du/split_7_2/helpers/ru_ofh_config_schema.h"
#include "apps/units/flexible_o_du/split_8/helpers/ru_sdr_config_schema.h"
...
void ocudu::declare_dynamic_o_du_unit_config_schema(config::config_builder&   b,
                                                                 dynamic_o_du_unit_config& parsed_cfg)
{
  declare_o_du_high_config_schema(b, parsed_cfg.odu_high_cfg);
  declare_du_low_config_schema(b, parsed_cfg.du_low_cfg);
  declare_ru_ofh_config_schema(b, ofh_cfg);
  declare_ru_sdr_config_schema(b, sdr_cfg);
  ...
  app_helpers::declare_metrics_appconfig_schema(b, dummy_cfg.metrics_cfg.metrics_cfg);
