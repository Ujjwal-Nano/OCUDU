...
#include "split_8_o_du_unit_schema.h"
...
void ocudu::declare_split_8_o_du_unit_config_schema(config::config_builder&   b,
                                                                 split_8_o_du_unit_config& parsed_cfg)
{
  ...
  declare_ru_sdr_config_schema(b, parsed_cfg.ru_cfg);
}
