...
#include "ru_sdr_config_schema.h"
...
void ocudu::declare_ru_sdr_config_schema(config::config_builder& b, ru_sdr_unit_config& parsed_cfg)
{
  /// RU SDR section.
  ...
  // Metrics section.
  app_helpers::declare_metrics_appconfig_schema(b, parsed_cfg.metrics_cfg.metrics_cfg);
