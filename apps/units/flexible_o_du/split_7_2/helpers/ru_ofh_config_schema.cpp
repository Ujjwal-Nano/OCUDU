...
#include "ru_ofh_config_schema.h"
...
void ocudu::declare_ru_ofh_config_schema(config::config_builder& b, ru_ofh_unit_parsed_config& parsed_cfg)
{
  // OFH RU section.
  ...
  // Metrics section.
  app_helpers::declare_metrics_appconfig_schema(b, parsed_cfg.config.metrics_cfg.metrics_cfg);
