...
void ocudu::configure_cli11_with_split_7_2_o_du_unit_config_schema(config::config_builder&     b,
                                                                   split_7_2_o_du_unit_config& parsed_cfg)
{
  ...
  configure_cli11_with_ru_ofh_config_schema(b, parsed_cfg.ru_cfg);
}
                                                                   ...
                                                                   split_7_2_o_du_unit_config& parsed_cfg)
{
  ...
  configure_cli11_with_split_7_2_o_du_unit_config_schema(b, parsed_cfg);
}
