...
void ocudu::configure_cli11_with_split_7_2_o_du_unit_config_schema(CLI::App& app, split_7_2_o_du_unit_config& config)
{
  ...
  configure_cli11_with_ru_ofh_config_schema(app, config.ru_cfg);
}
