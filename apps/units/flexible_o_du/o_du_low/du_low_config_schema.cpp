...
#include "du_low_config_schema.h"
...
void ocudu::declare_du_low_config_schema(config::config_builder& b, du_low_unit_config& parsed_cfg)
{
  // Loggers section.
  ...
  // Metrics section.
  app_helpers::declare_metrics_appconfig_schema(b, parsed_cfg.metrics_cfg.common_metrics_cfg);
