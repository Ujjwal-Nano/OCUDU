...
#include "du_high_config_schema.h"
...
#include "ntn/du_high_ntn_config_schema.h"
...
void ocudu::declare_du_high_config_schema(config::config_builder& b, du_high_parsed_config& parsed_cfg)
{
  ...
  app_helpers::declare_metrics_appconfig_schema(b, parsed_cfg.config.metrics.common_metrics_cfg);
