...
static void configure_cli11_pcap_args(CLI::App& app, o_du_high_e2_config& config)
{
  add_option(app, "--e2ap_du_filename", config.pcaps.filename, "E2AP PCAP file output path")->capture_default_str();
