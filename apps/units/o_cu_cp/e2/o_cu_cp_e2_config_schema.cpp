...
#include "o_cu_cp_e2_config_schema.h"
...
void ocudu::declare_o_cu_cp_e2_config_schema(config::config_builder& b, o_cu_cp_e2_config& unit_cfg)
{
  b.group("pcap", "PCAP configuration", [&](config::config_builder& pcap) { declare_pcap_args(pcap, unit_cfg.pcaps); });

  declare_e2_config_schema(b, unit_cfg.base_config, "--enable_cu_cp_e2", "Enable CU E2 agent");
}
