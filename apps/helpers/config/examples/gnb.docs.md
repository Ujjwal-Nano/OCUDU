...
| `ran_node_name` | string | `gnb01` |  | RAN node name |
...
| Option | Type | Default | Constraints | Description |
|--------|------|---------|-------------|-------------|
| `ngap_filename` | string | `/tmp/gnb_ngap.pcap` |  | N3 GTP-U PCAP file output path |
...
| `f1ap_filename` | string | `/tmp/gnb_f1ap.pcap` |  | F1AP PCAP file output path |
| `f1ap_enable` | boolean | `false` |  | Enable F1AP packet capture |
| `e1ap_filename` | string | `/tmp/gnb_e1ap.pcap` |  | E1AP PCAP file output path |
